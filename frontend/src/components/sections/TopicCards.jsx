...
const topics = [
  { title: "Gia đình", wordCount: "120 từ", imageSrc: "https://c.animaapp.com/zdBS24aH/img/image-container-5.svg" },
  { title: "Du lịch", wordCount: "150 từ", imageSrc: "https://c.animaapp.com/zdBS24aH/img/image-container-6.svg" },
  { title: "Ẩm thực", wordCount: "180 từ", imageSrc: "https://c.animaapp.com/zdBS24aH/img/image-container-7.svg" },
  { title: "IELTS", wordCount: "800 từ", imageSrc: "https://c.animaapp.com/zdBS24aH/img/image-container-8.svg" },
  { title: "TOEIC", wordCount: "650 từ", imageSrc: "https://c.animaapp.com/zdBS24aH/img/image-container-9.svg" },
];
          ...
          <li key={topic.title}>
            <button type="button" className="relative flex w-full flex-col items-start gap-4 rounded-2xl border border-solid border-slate-200 bg-white p-3 text-left shadow-[0px_4px_16px_#0f172a0a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-500" aria-label={`Chọn chủ đề ${topic.title}, ${topic.wordCount}`}>
              ...
              <span className="relative flex w-full flex-[0_0_auto] flex-col items-start gap-1">
                ...
                <span className="relative w-full [font-family:'Rethink_Sans',Helvetica] text-[13px] font-normal leading-[normal] tracking-[0] text-slate-600">{topic.wordCount}</span>
              </span>
            </button>
          </li>
        ))}
